...
from config_app.telemetry.views import BaseTelemetryEvent
from config_app.utils import singleton
...
class ProductTelemetry:
	...
	USER_ID_PATH = str(Path.home() / '.cache' / 'config_app' / 'telemetry_user_id')
	...
	def __init__(self) -> None:
		...
		if telemetry_disabled:
			...
			logging.info(
				'Anonymized telemetry enabled. See for more information.'
			)
