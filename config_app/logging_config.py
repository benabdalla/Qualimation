...
def setup_logging():
	...
	log_type = os.getenv('QUALIMATION_LOGGING_LEVEL', 'info').lower()
	...
	class BrowserUseFormatter(logging.Formatter):
		def format(self, record):
			if type(record.name) == str and record.name.startswith('config_app.'):
	...
	# Configure config_app logger
	browser_use_logger = logging.getLogger('config_app')
