...
from config_app.browser.views import BrowserState, BrowserStateHistory, TabInfo
from config_app.controller.registry.service import Registry
from config_app.controller.views import ClickElementAction, DoneAction, ExtractPageContentAction
from config_app.dom.views import DOMElementNode
...
# run this with:
# pytest config_app/agent/tests.py
