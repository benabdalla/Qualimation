...
from config_app.agent.views import ActionResult
from config_app.browser.views import BrowserState, TabInfo
from config_app.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from config_app.agent.views import AgentBrain, AgentOutput
...
# pytest -s config_app/agent/message_manager/tests.py
