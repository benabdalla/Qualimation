...
from config_app.agent.message_manager.views import MessageMetadata
from config_app.agent.prompts import AgentMessagePrompt
from config_app.agent.views import ActionResult, AgentOutput, AgentStepInfo, MessageManagerState
from config_app.browser.views import BrowserState
from config_app.utils import time_execution_sync
...
class MessageManager:
	...
	def _init_messages(self) -> None:
		...
		self.add_tool_message(content='Qualimation started')
